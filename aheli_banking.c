...
int verify() {
    char a;
    if (m == 1) {
        if ((strcmp(id, "aheli_admin") == 0 && strcmp(password, "aheli@2003") == 0)) {
            gotoxy(38, 16);
        ...
        if (strcmp(id, "aheli_user") == 0 && strcmp(password, "aheli@2003") == 0) {
            gotoxy(38, 16);
            printf("You Have Successfully Logged In : \" %s \" ", id);
            gotoxy(44, 20);
            printf("Press any key to continue .... ");
...
void about() {
    ...
    printf("!!!ABOUT US!!!");
    gotoxy(32,12);
    printf("This project has been created by Aheli Poddar.");
    gotoxy(10,13);
    printf("It is a Simple Bank Management System Project for my 2nd Semester based on C programming language.");
    gotoxy(40, 22);
    printf("Press any key to return back to main menu. ");
    char z = getch();
    if (z == 13) {
